...
@Component({
  selector: 'app-pie-perairan',
  templateUrl: './pie-perairan.component.html',
  styleUrls: ['./pie-perairan.component.css']
})
export class PiePerairanComponent implements OnInit  {
  categoryumum:any = []
  count2017:number = 0
  count2018:number = 0
  count2019:number = 0
  ...
  urlBase = "https://opendata.jabarprov.go.id/api-backend/bigdata/diskanlut/od_18465_jml_nelayan__jenis_perairan_kabupatenkota?limit=100&search=PERAIRAN%20UMUM"
  ...
  private createSvg(): void {
    this.svg = d3.select("figure#pie-perairan")
    .append("svg")
